...
| D34 | 2026-09-26 | La tarjeta de hoy y el detalle comparten piezas (`BloqueDias`, `LineaCiclo` y el semáforo al pie) con fondos distintos: verde solo para la recomendada, blanco en el detalle. La línea del ciclo es compacta en inicio (Cortó y Corta) y completa en el detalle (Cortó, Hoy, Corta y Pagas), con meses cortos ("8 sept."). Bajo el nombre no se repite el banco si el alias ya lo trae | Quien aprende a leer una tarjeta lee la otra; pintar de verde una tarjeta en "Espera" diría que conviene usarla |
| D35 | 2026-09-26 | En la línea completa del ciclo (detalle) cada punto va encima de su etiqueta y el relleno llega hasta "Hoy"; en la compacta (tarjeta de hoy) el relleno es proporcional a los días transcurridos entre "Cortó" y "Corta" | Con la línea proporcional el relleno no llegaba a la etiqueta "Hoy" y parecía un error; el orden de los hitos nunca cambia, así que las posiciones fijas no engañan |
