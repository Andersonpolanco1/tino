...
- [ ] Agregar "Idioma" en Ajustes cuando exista un segundo idioma (por ejemplo, inglés para EE. UU.)
...
| D50 | 2026-09-26 | Ajustes > General queda con Tus cobros, Enfoque y País; las monedas pasan a ser el detalle del país ("República Dominicana · Pesos y dólares") | Las monedas salen del país y no se eligen; una fila solo informativa ocupaba espacio. País va al final porque casi no se cambia |
| D51 | 2026-09-26 | Ajustes > Apariencia: Automático (como el teléfono, por defecto), Claro u Oscuro, en el campo opcional `Preferencias.tema`; se aplica con `Appearance.setColorScheme`, que cambia toda la app, incluidos el teclado y los diálogos del sistema. Sin selector de idioma mientras haya uno solo | La sección 8.1 técnica solo seguía al sistema; elegir el modo por app es lo que la gente espera. Un selector con un solo idioma no sirve |
